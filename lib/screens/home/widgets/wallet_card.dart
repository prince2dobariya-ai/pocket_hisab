                    ...
                    children: [
                      const Row(
                        ...
                        children: [
                          ...
                          Text("Wallet", style: TextStyle(color: Colors.green)),
                        ],
                      ),
                      Text(
                        CurrencyHelper.format(walletTotal),
